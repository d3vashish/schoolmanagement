...
# DISCONNECTED (2026-06-25): online payment via Razorpay was built around the
# Invoice/PaymentOrder models, which have been removed in favor of the
# receipt-based fee model (see fees/service.py and fees/models.py). The
# webhook route in fees/router.py is also commented out for the same reason.
# To re-enable online payments, this function needs rewriting against
# FeeReceipt instead of Invoice, and the route needs reconnecting.
#
